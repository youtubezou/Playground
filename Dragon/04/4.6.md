...
| STATE | $$($$ | $$)$$ | $$\$$$ | $$S$$ |
|:-----:|:-----:|:-----:|:------:|:-----:|
| 0 | s2 / r($$S \rightarrow \epsilon$$) | r($$S \rightarrow \epsilon$$) | r($$S \rightarrow \epsilon$$) | 1 |
| 1 |  |  |  |  |
| 2 | s2 / r($$S \rightarrow \epsilon$$) | r($$S \rightarrow \epsilon$$) | r($$S \rightarrow \epsilon$$) | r($$S \rightarrow \epsilon$$) | 3 |
| 3 |  | s4 |  |  |
| 4 | s2 / r($$S \rightarrow \epsilon$$) | r($$S \rightarrow \epsilon$$) | r($$S \rightarrow \epsilon$$) | r($$S \rightarrow \epsilon$$) | 5 |
| 5 | s2 / r($$S \rightarrow \epsilon$$) | r($$S \rightarrow \epsilon$$) | r($$S \rightarrow \epsilon$$) | r($$S \rightarrow \epsilon$$) | 6 |
| 6 | r($$S \rightarrow (~S~)~S~S$$) | r($$S \rightarrow (~S~)~S~S$$) | r($$S \rightarrow (~S~)~S~S$$) |  |
...
> $$S \rightarrow A_i b_i$$ for $$1 \le i \le n$$

> $$A_i \rightarrow a_j A_i | a_j$$ for $$1 \le i,j \le n$$ and $$i \ne j$$

> Show that

> a) $$G_n$$ has $$2n^2 - n$$ productions.

$$S \rightarrow A_i b_i$$: $$n$$,

$$A_i \rightarrow a_j A_i$$: $$n^2 - n$$,

$$A_i \rightarrow a_j$$: $$n^2 - n$$,
