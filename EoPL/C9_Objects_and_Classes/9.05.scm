...
(define (object->class o)
  (cases object o
    (an-object (class fields) class)))

(define (object->fields o)
  (cases object o
    (an-object (class fields) fields)))
...
(define (find-method-in-obj o name)
  (cases object o
    (an-object (c fields)
  ...
  (cases expression exp
    ...
    (new-object-exp (class-name rands)
                    (let ((args (values-of-exps rands env))
                      ...
                      (apply-method (find-method-in-obj obj 'initialize)
                                    obj
                                    args)
                      obj))
    (method-call-exp (obj-exp method-name rands)
                     (let ((args (values-of-exps rands env))
                       ...
                       (apply-method (find-method-in-obj obj method-name)
                                     obj
                                     args)))
    (super-call-exp (method-name rands)
                    (let ((args (values-of-exps rands env))
                          (obj (apply-env-val env '%self)))
                      (apply-method (find-method (class->super-name
                                                  (lookup-class
                                                   (class->super-name
                                                    (object->class
